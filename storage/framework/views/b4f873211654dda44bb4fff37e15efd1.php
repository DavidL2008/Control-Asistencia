...
<div class="modal fade" id="eliminar<?php echo e($horario->id); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo Form::model($horario, [
                'method' => 'DELETE',
                'route' => ['horario.destroy', $horario->id],
            ]); ?>
...
<!---fin ventana Editar--->
<?php /**PATH C:\laragon\www\Control-Asistencia\resources\views/horario/modal/eliminar.blade.php ENDPATH**/ ?>