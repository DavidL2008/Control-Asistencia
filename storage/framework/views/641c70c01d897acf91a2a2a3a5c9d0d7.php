<?php $__env->startSection('title', 'Cargo'); ?>
            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class="fas fa-fw fa-share mr-2"></i>Cargo</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="card card-dark">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary mb-1" data-toggle="modal"
                            data-target="#crear"><strong>Agregar Cargo</strong>
                            <i class="fas fa-file"></i>
                        </button>
                        <!--Ventana Modal para Crear--->
                        <?php echo $__env->make('cargo.modal.crear', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#editar<?php echo e($cargo->id); ?>">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#eliminar<?php echo e($cargo->id); ?>">
                                                <i class="far fa-trash-alt icon-size"></i>
                                            </button>
                                        </td>
                                        <!--Ventana Modal para la Alerta de mostrar--->
                                        <?php echo $__env->make('cargo.modal.editar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <?php echo $__env->make('cargo.modal.eliminar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Control-Asistencia\resources\views/cargo/index.blade.php ENDPATH**/ ?>